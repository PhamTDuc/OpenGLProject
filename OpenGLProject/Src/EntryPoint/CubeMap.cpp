...
int main() {
	...
	Shader reflectShader("GLSL/Reflection/Vertex.vs", "GLSL/Reflection/Fragment.fs");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		reflectShader.use();
		reflectShader.setMat4fv("view", 1, GL_FALSE, cam.getView());
		reflectShader.setMat4fv("projection", 1, GL_FALSE, projection);
		glm::mat4 model(1.0f);
		model = glm::scale(model, glm::vec3(2.0f));
		model = glm::translate(model, glm::vec3(0.0f,0.0f,0.0f));
		reflectShader.setMat4fv("model", 1, GL_FALSE, model);
		glActiveTexture(GL_TEXTURE0);
		glBindTexture(GL_TEXTURE_CUBE_MAP, cubemapTexture);
		reflectShader.setInt("skybox",0);
		reflectShader.setVec3("camPos", cam.getPos());
		glBindVertexArray(cubeVAO);
		glDrawArrays(GL_TRIANGLES, 0, 36);
